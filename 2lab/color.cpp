...
public:
    ...
    CalcNode() : x(0.0), y(0.0), z(0.0), color(0)
    {
    }
    ...
    void move(double time) {
        color = 100*sin(0.2*z - 2 * M_PI * time);
    }
};
...
public:
    ...
    void snapshot(unsigned int snap_number) {
        ...
        for(unsigned int i = 0; i < nodes.size(); i++) {
            ...
            color->InsertNextValue(nodes[i].color);
        }
        ...
        unstructuredGrid->GetPointData()->AddArray(color);
        ...
        string fileName = "color_snaps/goose_color_step_" + std::to_string(snap_number) + ".vtu";
